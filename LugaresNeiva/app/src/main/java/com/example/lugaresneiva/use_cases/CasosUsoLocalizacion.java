...
import com.example.lugaresneiva.adapter.AdaptadorLugares;
...
public class CasosUsoLocalizacion implements LocationListener {
    ...
    public CasosUsoLocalizacion(Activity actividad, int codigoPermiso) {
        ...
        posicionActual = ((MyApplication) actividad.getApplication()).posicionActual;
        adaptador = ((MyApplication) actividad.getApplication()).adaptador;
        ultimaLocalizazion();
    }
    ...
    @Override public void onStatusChanged(String proveedor, int estado, Bundle extras) {
